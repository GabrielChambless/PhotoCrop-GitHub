...
//        // Calculate the optimal button size based on the inspector width
//        float inspectorWidth = EditorGUIUtility.currentViewWidth;
//        int buttonsPerRow = grid.x;
//        float buttonSize = Mathf.Min(50, (inspectorWidth - (buttonsPerRow * 4)) / buttonsPerRow); // 4 is a buffer for margins
...
//                if (index < holeLayout.arraySize) // Ensure the index is within bounds
//                {
//                    SerializedProperty cell = holeLayout.GetArrayElementAtIndex(index);
//                    SerializedProperty contentType = cell.FindPropertyRelative("CellContentType");
//                    SerializedProperty isFilled = cell.FindPropertyRelative("IsFilled");

//                    SerializedProperty position = cell.FindPropertyRelative("Position");
//                    position.vector2IntValue = new Vector2Int(x, y); // Assign the grid position directly
...
//            case GameStats.CellContentTypes.Wall:
//                return Color.white;
//            case GameStats.CellContentTypes.RedShape:
//                return Color.red;
//            case GameStats.CellContentTypes.GreenShape:
//                return Color.green;
//            case GameStats.CellContentTypes.BlueShape:
//                return Color.blue;
//            default:
//                return defaultColor;
//        }
